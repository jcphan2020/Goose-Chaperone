...
MODEL_NAME = '' # The path to the directory where frozen_inference_graph is stored. 
IMAGE_NAME = 'images_scaled/images/testing/image_1014859891.jpg' # The path to the image in which the object has to be detected. 
